...
const Modal = () => {
  ...
  const toggleSmallModal = () => setIsSmallModalOpen(!isSmallModalOpen);
  const toggleMediumModal = () => setIsMediumModalOpen(!isMediumModalOpen);
  const toggleLargeModal = () => setIsLargeModalOpen(!isLargeModalOpen);
  const toggleExtraLargeModal = () => setIsExtraLargeModalOpen(!isExtraLargeModalOpen);
